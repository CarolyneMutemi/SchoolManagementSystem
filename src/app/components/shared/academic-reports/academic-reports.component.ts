...
//           <input 
//             type="text" 
//             [placeholder]="viewMode === 'student' ? 'Search by Student Name/ID' : 'Search by Subject'"
//             [(ngModel)]="searchTerm"
//             style="margin-right: 12px;"
//           >
//         </div>

//         <div class="filter-controls" style="margin-left: 45px;">
//           <select [(ngModel)]="filterType">
//             <option value="form">Filter by Form</option>
//             <option value="stream">Filter by Stream</option>
//           </select>
...
//           </thead>
//           <tbody>
//             <tr *ngFor="let report of filteredAggregateReports">
//               <td>{{report.formOrStream}}</td>
//               <td>{{report.overallMean | number:'1.1-2'}}</td>
//               <td *ngFor="let subject of subjects">
//                 {{getSubjectMean(report, subject) | number:'1.1-2'}}
//               </td>
//               <td>
//                 <button class="view-btn" (click)="openAggregateDetails(report)">
